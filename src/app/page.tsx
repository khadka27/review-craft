                  ...
                  <ul className="text-xs sm:text-sm text-blue-800 space-y-2 sm:space-y-3">
                    <li className="flex items-start">
                      ...
                      <span className="leading-relaxed">
                        Keep content natural and avoid overly promotional
                        language
                      </span>
                    </li>
                    <li className="flex items-start">
            ...
            <div className="flex items-start gap-2 sm:gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="text-yellow-800 text-xs sm:text-sm leading-relaxed">
                  ...
                  presentations only. Creating fake reviews for deceptive
                  purposes is unethical and may violate platform terms of
                  service. Always use generated content responsibly and in
