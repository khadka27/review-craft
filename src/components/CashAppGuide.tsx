...
export function CashAppGuide() {
  ...
  const steps = [
    {
      step: "01",
      title: "Input $Cashtag Details",
      desc: "Enter sender $cashtag, recipient name, $cashtag, and amount ($).",
    },
    {
      step: "02",
      title: "Set Transaction Reference",
      desc: "Customize Cash App Identifier (#...), date/time stamp, and web link.",
    },
    {
      step: "03",
      title: "Configure Status & Note",
      desc: "Set payment status to Completed or Pending and add custom note emojis.",
    },
    {
      step: "04",
      title: "Export Image",
      desc: "Download the completed Cash App payment receipt as PNG, WEBP, JPG, or PDF.",
    },
  ];

  const features = [
    "Authentic Cash App green theme UI",
    "Support for $Cashtag formatting",
    "Editable Cash App identifier code",
  ...
  const faqs = [
    {
      q: "What is a Cash App receipt generator?",
      a: "A Cash App receipt generator is a design tool for creating simulated Cash App payment confirmation screenshots for app prototyping, marketing materials, and educational workshops.",
    },
    {
      q: "Is this Cash App generator free?",
      a: "Yes, our Cash App payment mockup builder is completely free.",
    },
  ];
  ...
  return (
    <div className="space-y-16 py-12 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto text-slate-200">
      <Script
        id="cashapp-faq-schema"
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(faqSchema) }}
      />

      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-tr from-[#00a33c] via-[#00d64f] to-[#34e26d] p-8 sm:p-12 shadow-2xl border border-emerald-500/60">
        <div className="absolute top-0 left-0 w-full h-1.5 bg-[#00d64f]" />
        ...
        <div className="relative z-10 max-w-3xl text-white">
          <span className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-xs font-bold bg-white/10 text-white border border-white/20 mb-6 uppercase tracking-wider">
            <CreditCard size={13} className="text-emerald-200 animate-pulse" /> Cash App Studio
          </span>
          ...
          <p className="text-base sm:text-lg text-emerald-100 leading-relaxed font-normal">
            Create realistic Cash App payment screenshots and $cashtag transaction mockups in seconds. Customize amounts, recipient $cashtags, reference codes, and timestamps for fintech presentations.
          </p>
        </div>
      </div>
        ...
        <div className="lg:col-span-6 bg-[#111827] rounded-2xl p-6 sm:p-8 shadow-xl border border-[#1E293B] flex flex-col justify-between">
          <div className="space-y-4">
            ...
            <p className="text-[#94A3B8] text-sm sm:text-base leading-relaxed">
              The Cash App generator lets designers and mobile developers simulate Cash App payment confirmation screens matching official Cash App mobile interface designs.
            </p>
          </div>
        </div>
        ...
        <div className="lg:col-span-6 bg-[#111827] rounded-2xl p-6 sm:p-8 shadow-xl border border-[#1E293B] flex flex-col justify-between">
          <div className="space-y-4">
            ...
            <p className="text-[#94A3B8] text-sm leading-relaxed">
              Great for mobile checkout prototyping, sales pitch decks, payment verification demos, and UI wireframing.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-8">
        <div className="text-center max-w-2xl mx-auto space-y-2">
          <h3 className="text-2xl sm:text-3xl font-extrabold text-[#F8FAFC]">
            How to Create a Cash App Mockup
          </h3>
        </div>
      ...
      <div className="bg-[#111827] border border-amber-500/20 rounded-2xl p-6 sm:p-8 flex flex-col sm:flex-row items-start gap-4 max-w-4xl mx-auto">
        ...
        <div className="space-y-2">
          ...
          <p className="text-[#94A3B8] text-xs sm:text-sm leading-relaxed">
            This Cash App generator is strictly intended for UI design, educational presentations, and software demonstrations. Generated receipts are fictional. Do not use for fraudulent claims.
          </p>
        </div>
      </div>
