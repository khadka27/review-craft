        ...
        <div className="w-full bg-white/10 backdrop-blur-md rounded-[2.5rem] p-8 space-y-8 border border-white/10">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm opacity-60 font-bold tracking-tight">
                ${data.receiverName.toLowerCase().replace(/ /g, "")}
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center text-sm">
              <span className="font-bold opacity-70 uppercase tracking-widest text-[10px]">
                Status
              </span>
              <span
            ...
            <div className="flex justify-between items-center text-sm">
              ...
              <span className="font-mono font-bold text-[10px] uppercase tracking-tighter">
