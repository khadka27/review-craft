        ...
        <div className="flex gap-4">
          ...
          <aside className="w-[250px] flex-shrink-0">
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="text-[#9eb7cc] text-[22px] font-bold leading-tight">
                  {data.username || "KratomCowgirl"}
                </div>
                <div className="text-[#6f8598] text-[28px]">
          ...
          <section className="flex-1 min-w-0">
            <div className="flex items-start justify-between bg-[#101923] border border-[#24384d] p-2 mb-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-[#c7d5e0] font-bold text-[26px] leading-tight">
                    {isRecommended ? "Recommended" : "Not Recommended"}
                  </div>
                  <div className="text-[#8ba2ad] text-[18px] leading-tight">
            ...
            <div className="text-[#5f7387] uppercase text-[18px] mb-2">
              Posted: {format(data.date || new Date(), "MMM d")}
            </div>

            <div className="text-[#c7d5e0] text-[24px] leading-[1.35] mb-4 whitespace-pre-wrap">
              {data.content}
            </div>

            <div className="h-[1px] bg-[#3a4f63] mb-2" />

            <div className="text-[#6f8598] text-[18px] mb-2">
              Was this review helpful?
            </div>

            <div className="flex items-center gap-2 mb-3 flex-wrap">
              <button className="px-3 py-1 bg-[#233142] border border-[#2e3f52] text-[#66c0f4] text-[16px] rounded-sm flex items-center gap-1">
                <ThumbsUp size={16} /> Yes
              </button>
              <button className="px-3 py-1 bg-[#233142] border border-[#2e3f52] text-[#66c0f4] text-[16px] rounded-sm flex items-center gap-1">
                <ThumbsDown size={16} /> No
              </button>
              <button className="px-3 py-1 bg-[#233142] border border-[#2e3f52] text-[#6f8598] text-[16px] rounded-sm">
                Funny
              </button>
              <button className="px-3 py-1 bg-[#233142] border border-[#2e3f52] text-[#8fa0b2] text-[16px] rounded-sm flex items-center gap-1">
                <Award size={16} className="text-[#e5da2d]" /> Award
              </button>
            </div>

            <div className="text-[#7f8f9d] text-[20px] leading-tight">
              <div>{helpfulCount} people found this review helpful</div>
              <div>{funnyCount} people found this review funny</div>
            </div>

            <div className="mt-3 flex items-center justify-between">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#0f2438] rounded text-[20px] text-[#66c0f4]">
                <span>🎯</span>
                <span>{awardCount}</span>
              </div>
              <div className="flex items-center gap-1 text-[#66c0f4] text-[20px]">
                <span>2</span>
