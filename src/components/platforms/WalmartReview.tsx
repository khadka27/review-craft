    ...
    <div className="bg-white border border-gray-200 rounded-lg p-4 sm:p-6 w-full max-w-2xl mx-auto">
      ...
      <div className="flex items-start gap-3 sm:gap-4 mb-4">
        {data.avatar ? (
          ...
          <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gradient-to-br from-blue-500 to-yellow-400 flex items-center justify-center flex-shrink-0">
      ...
      <div className="bg-gray-50 rounded-lg p-3 mb-4">
        <div className="text-sm text-gray-700">
          <div className="flex items-center gap-4 mb-2">
            <span className="font-medium">Incentivized:</span>
            <span>No</span>
          </div>
          {data.productVariation && (
            <div className="flex items-center gap-4">
              <span className="font-medium">Variant:</span>
              <span>{data.productVariation}</span>
            </div>
          )}
        </div>
      </div>
      ...
      <div className="bg-blue-50 rounded-lg p-3 mb-4">
        <div className="text-sm text-blue-900">
          <span className="font-medium">{data.likes} out of {data.likes + Math.floor(Math.random() * 10)} found this helpful</span>
        </div>
      </div>
